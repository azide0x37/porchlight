...
check "ai analysis executable exists" test -x "$CURRENT/bin/porchlight-ai-analysis"
...
check "ai analysis service unit exists" test -f "$CURRENT/systemd/porchlight-ai-analysis.service"
check "ai analysis timer unit exists" test -f "$CURRENT/systemd/porchlight-ai-analysis.timer"
...
MUSTER_MOCK_ROOT="$MOCK_ROOT" "$CURRENT/bin/porchlight-ai-analysis" >/dev/null
check "ai analysis status rendered" test -s "$MOCK_ROOT/var/lib/porchlight/www/analysis.json"
